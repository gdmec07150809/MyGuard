package com.example.administrator.myguard.m2theftguard.service;
...
public class GPSLocationService extends Service {
    ...
    private class MyListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            String safenmber = sp.getString("safephone", "");
            SmsManager.getDefault().sendTextMessage(safenmber, null, result, null, null);
            stopSelf();
        }
