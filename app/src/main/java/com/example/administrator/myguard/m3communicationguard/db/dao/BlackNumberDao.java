package com.example.administrator.myguard.m3communicationguard.db.dao;
...
import com.example.administrator.myguard.m3communicationguard.db.BlackNumberOpenHelper;
...
public class BlackNumberDao {
    ...
    public List<BlackContactInfo> getPageBlackNumber(int pageumber, int pagesize) {
        SQLiteDatabase db = blackNumberOpenHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery(
                "select number,mode,name from blacknumber limit ? offset ?",
                new String[] {
                        String.valueOf(pagesize),
                        String.valueOf(pagesize*pageumber)});
